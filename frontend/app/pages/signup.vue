...
<template>
  <div class="min-h-screen bg-slate-100 flex items-center justify-center px-4">
    <div class="bg-white rounded-2xl shadow p-8 w-full max-w-sm">
      <h1 class="text-2xl font-bold text-slate-800 mb-2">Set up your account</h1>

      <p v-if="checking" class="text-slate-400 text-sm">Checking your invite…</p>

      <template v-else-if="validInvite">
        <p class="text-slate-500 text-sm mb-6">Welcome, {{ employeeName }}. Create your login below.</p>
